 ...
 *
 */
data class SocialMediaAdapter (private val context: Context?, private val faq: List<SocialMedia>) : RecyclerView.Adapter<SocialMediaAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_list_social_media, parent, false))

    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.bindItem(faq[position])
    }
