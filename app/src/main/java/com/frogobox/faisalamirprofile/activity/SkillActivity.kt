...
class SkillActivity : AppCompatActivity() {
    ...
    private fun initListView(){
        ...
        arrayProduct.add(Product(getString(R.string.product_name_cat),
            R.drawable.ic_product_cat,
            R.drawable.ic_product_type_android
        ))
        arrayProduct.add(Product(getString(R.string.product_name_finpro),
            R.drawable.ic_product_finpro,
            R.drawable.ic_product_type_android
        ))
        arrayProduct.add(Product(getString(R.string.product_name_football),
            R.drawable.ic_product_football,
            R.drawable.ic_product_type_android
        ))
        arrayProduct.add(Product(getString(R.string.product_name_frogonews),
            R.drawable.ic_product_frogonews,
            R.drawable.ic_product_type_android
        ))
        arrayProduct.add(Product(getString(R.string.product_name_jagosholat),
            R.drawable.ic_product_jagosholat,
            R.drawable.ic_product_type_android
        ))
        arrayProduct.add(Product(getString(R.string.product_name_jami),
            R.drawable.ic_product_jami,
            R.drawable.ic_product_type_android
        ))
        arrayProduct.add(Product(getString(R.string.product_name_movie),
            R.drawable.ic_product_movie,
            R.drawable.ic_product_type_android
        ))
        arrayProduct.add(Product(getString(R.string.product_name_mood),
            R.drawable.ic_product_mood,
            R.drawable.ic_product_type_android
        ))
        arrayProduct.add(Product(getString(R.string.product_name_romis),
            R.drawable.ic_product_romis,
            R.drawable.ic_product_type_android
        ))
        arrayProduct.add(Product(getString(R.string.product_name_shejek),
